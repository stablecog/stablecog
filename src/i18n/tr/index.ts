...
const tr: Translation = {
	...
	Home: {
		...
		ImageInput: {
			NotSupported: 'Model bunu desteklemiyor',
	...
	Account: {
		...
		Subscription: {
			...
			CancelPlanTitle: 'Paketi İptal Et',
			PlanChangedTitle: 'Paket Değiştirildi',
			SubscriptionCancelledTitle: 'Abonelik İptal Edildi',
			PlanCancelledTitle: 'Paket İptal Edildi',
			ChangePlanTitle: 'Paket Değiştir',
			CancelSubscriptionTitle: 'Aboneliği İptal Et',
			CancelSubscriptionButton: 'Aboneliği İptal Et',
			CurrentPlanTitle: 'Mevcut Paket',
			NewPlanTitle: 'Yeni Paket',
			AmountDueTitle: 'Alınacak Ödeme',
			UpcomingChargeTitle: 'Gelecek Ödeme',
			Downgrade: {
	...
	Pricing: {
		...
		Monthly: '{planTitle} (aylık)',
		Yearly: '{planTitle} (yıllık)',
		NoBilling: 'Faturalama yok',
		BilledYearly: 'Yıllık faturalama',
		BilledMonthly: 'Aylık faturalama',
		SwitchToYearlyButton: 'Yıllığa Geç',
		SwitchToMonthtlyButton: 'Aylığa Geç',
	...
	Legal: {
		...
		AcceptedPoliciesParagraph: `Servisimizi kullanarak, {termsOfService}'nı ve {privacyPolicy}'nı kabul ediyorsun.`,

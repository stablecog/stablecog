...
const bg: Translation = {
	...
	Home: {
		...
		NegativePromptInput: {
			...
			Paragraph: 'Премахва нежелани елементи от изображението. Напътствия които да не се следват.'
		},
		ImageInput: {
		...
		SchedulerDropdown: {
			Title: 'Планировчик',
			Paragraph:
				'Обезшумява изображението по определен начин. Може драстично да промени резултата. Различни типове изискват по-малко или повече стъпки за постигане на добри резултати.'
		},
		SubmitToGalleryQuestion: {
			Title: 'Качи изображенията в галерията?',
			Paragraph: 'Можете по-късно да промените настройките си.'
		}
	},
	History: {
		GenerationsTitle: 'Създадени изображения',
		GenerationsMaxSavedCountWarning: 'Само последните {count}',
		DownloadLegacyGenerationsButton: 'Изтегли остарели изображения',
	...
	Live: {
		...
		WaitingTitle: 'Изчакване на изображения',
	...
	Settings: {
		...
		GenerationSettingsButton: 'Опции за създаване',
		GenerationSettingsTitle: 'Опции за създаване',
	...
	Shared: {
		StartGeneratingTitle: 'Започни да създаваш прекрасни изображения!',
		...
		Credits: {
			CreditsTable: {
				...
				RemainingCreditsTitle: 'Оставащи',
				ExpiryTitle: 'Изтича',
		...
		BatchEditBar: {
			...
			UnfavoriteButton: 'Премахни харесани ({selectedCount})',
			ConfirmationModal: {
				CancelButton: 'Отмяна',
				Deselect: {
	...
	Error: {
		...
		NotFound: 'Не намерен',
		SupabaseNotFoundCantListen: 'Инстанцията "Supabase" не бе намерена.',
	...
	Admin: {
		...
		NoGenerationsToReview: 'Няма изображения за преглеждане.',
	...
	Pro: {
		...
		Features: {
			...
			Upscale: 'Увеличи изображения',
			Steps: 'Различен брой стъпки',
			MoreModels: 'Повече модели',
			MoreSchedulers: 'Повече планировчици',
		...
		Reason: {
			...
			ParagraphUpscale: 'Оголемяването е недостъпно на безплатен план.',
			...
			ParagraphScheduler: 'Този планировчик е недостъпен на безплатен план.',
			ParagraphWidthGeneration:
				'Това изображение бе създадено от друго, със ширина, недостъпна на безплатен план.',
			ParagraphHeightGeneration:
				'Това изображение бе създадено от друго, с височина, недостъпна на безплатен план.',
			ParagraphDimensionsGeneration:
				'Това изображение бе създадено от друго, с размери, недостъпни на безплатен план.',
			ParagraphInferenceStepsGeneration:
				'Това изображение бе създадено от друго, с брой стъпки, недостъпни на безплатен план.',
			ParagraphModelGeneration:
				'Това изображение бе създадено от друго, с модел, недостъпен на безплатен план.',
			ParagraphSchedulerGeneration:
				'Това изображение бе създадено от друго, с планировчик, недостъпен на безплатен план.'
		},
		Tier: {
			Title: {
				Free: 'Безплатен',
	...
	Account: {
		...
		RemainingImagesTitle: 'Оставащи изображения',
	...
	Pricing: {
		...
		Features: {
			...
			MonthlyGenerations: '{count} действия на месец.',
			Images: '{count} изображения.',
			Generations: '{count} действия.',

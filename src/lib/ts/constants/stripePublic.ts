...
export const STRIPE_PRICE_IDS_CREDIT_PACKS = [PUBLIC_STRIPE_PRICE_ID_MEDIUM_PACK];
export const STRIPE_PRODUCT_IDS_CREDIT_PACKS = [PUBLIC_STRIPE_PRODUCT_ID_MEDIUM_PACK];

	...
	>
		<div tw="w-full flex flex-col">
			<div tw="w-full flex items-center">
				<svg
					style="width: 4.5rem; height: 4.5rem; margin-left: -0.5rem"
					...
					><defs
						><linearGradient
							...
							><stop stop-color="#9866FF" /><stop offset="1" stop-color="#C3A6FF" /></linearGradient
						><linearGradient
							id="c"
							x1="15.594"
							x2="18.031"
							...
							y2="17.468"
							gradientUnits="userSpaceOnUse"
							><stop stop-color="#0F0F12" stop-opacity=".1" /><stop
								offset="1"
								stop-color="#0F0F12"
								stop-opacity="0"
							/></linearGradient
						...
						><linearGradient
							...
							y2="16.818"
							gradientUnits="userSpaceOnUse"
							><stop stop-color="#9C6CFF" /><stop offset="1" stop-color="#925CFF" /></linearGradient
						><linearGradient
							id="f"
							x1="16.38"
							x2="26.967"
							...
							y2="7.723"
							gradientUnits="userSpaceOnUse"
							><stop stop-color="#AD85FF" /><stop offset="1" stop-color="#CEB7FF" /></linearGradient
						></defs
					></svg
				>

...
{:else if locale === 'hr'}
	...
	>
		...
		<path d="M0 0h512v341H0V0z" fill="#fff" />
		<path
			d="M0 0h512v171H0V0zM256 388a100 100 0 0 0 100-99V171H157v118a100 100 0 0 0 99 100v-1z"
			fill="red"
		/>
		<path
			d="M256 387a98 98 0 0 0 98-98V173H158v116a98 98 0 0 0 29 69 98 98 0 0 0 69 29z"
			fill="#fff"
		/>
		<path
			d="M200 176h-38v41h38v-41zm0 83h37v-42h-37v42zm-38 30 1 11h37v-41h-38v30zm113-30h-38v41h38v-41zm0 82h37v-41h-37v41zm37 23a95 95 0 0 0 22-23h-22v23zm-112-23h37v-41h-37v41zm-22 0a95 95 0 0 0 22 23v-23h-22zm85 42a93 93 0 0 0 12-2v-40h-38v40a93 93 0 0 0 26 2zm86-83 1-11v-30h-38v41h37zm-74-41h37v-41h-37v41zm0-83h-38v42h38v-42zm75 42v-42h-38v41h38z"
			fill="red"
		/>
		<path
			d="m352 169 23-52-17-29-30 11-20-24-28 16-24-20-24 20-28-16-20 24-29-11-18 29 23 53a232 232 0 0 1 96-21c34 0 67 7 96 21v-1z"
			fill="#fff"
		/>
		<path d="m185 101-30-11-16 27 6 14 16 36a234 234 0 0 1 37-13l-13-53z" fill="#0093DD" />
		<path d="m232 93-27-15-20 23 13 53a234 234 0 0 1 39-6l-5-55z" fill="#171796" />
		<path
			d="M195 141a248 248 0 0 1 40-7l-1-14a262 262 0 0 0-43 8l4 13zm-7-27a275 275 0 0 1 45-7l-1-14a289 289 0 0 0-47 8l3 13z"
			fill="red"
		/>
		<path d="m281 93-25-19-24 19 5 55a237 237 0 0 1 19-1l20 1 5-55z" fill="#0093DD" />
...
{:else if locale === 'bg'}
	<svg
		...
		xmlns="http://www.w3.org/2000/svg"
	>
		<path fill-rule="evenodd" clip-rule="evenodd" d="M0 341.3H512V512H0V341.3Z" fill="#D62612" />

...
import { AppBarDropdown } from '$routes/chatgpt/components/util/AppBarDropdown';
import { AppBarDropdownWithSymbol } from '$routes/chatgpt/components/util/AppBarDropdownWithSymbol';
import { type ChatModelId, ChatModels, type SystemPurposeId, SystemPurposes } from '$routes/chatgpt/lib/data';
import { ConfirmationModal } from '$routes/chatgpt/components/dialogs/ConfirmationModal';
import { PagesMenu } from '$routes/chatgpt/components/Pages';
...
export function ApplicationBar(props: {
  ...
  // const { mode: colorMode, setMode: setColorMode } = { mode: , setMode: };

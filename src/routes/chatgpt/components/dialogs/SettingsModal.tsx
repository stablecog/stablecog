...
import languages from '$routes/chatgpt/lib/languages.json' assert { type: 'json' };
import type { ElevenLabs } from '$routes/chatgpt/types/api-elevenlabs';
...
const requireUserKeyOpenAI = !env.HAS_SERVER_KEY_OPENAI;

export const requireUserKeyElevenLabs = !env.HAS_SERVER_KEY_ELEVENLABS;
      ...
      <Stack direction='column' sx={{ gap: uniformGap, mt: -0.8, maxWidth: 400 }}>
        ...
        <FormControl orientation='horizontal' sx={{ justifyContent: 'space-between' }}>
          <Box sx={{ minWidth: 130 }}>
            ...
            <FormHelperText sx={{ display: 'block' }}>
              For <a level='body2' href='https://www.helicone.ai' target='_blank'>Helicone</a>
            </FormHelperText>
          </Box>
          <Input
        ...
        <FormControl orientation='horizontal' sx={{ justifyContent: 'space-between' }}>
          <Box sx={{ minWidth: 130 }}>
            ...
            <FormHelperText sx={{ display: 'block' }}>
              <a level='body2' href='https://github.com/enricoros/nextjs-chatgpt-app/issues/63' target='_blank'>What is this</a>
            </FormHelperText>
          </Box>
          <Input
          ...
          <FormControl>
            ...
            <FormHelperText sx={{ display: 'block', lineHeight: 1.75 }}>
              {requireUserKeyOpenAI
                ? <><a level='body2' href='https://platform.openai.com/account/api-keys' target='_blank'>Create Key</a>, then apply to
                  the <a level='body2' href='https://openai.com/waitlist/gpt-4-api' target='_blank'>GPT-4 waitlist</a></>
                : `This key will take precedence over the server's.`} <a level='body2' href='https://platform.openai.com/account/usage' target='_blank'>Check usage here</a>.
            </FormHelperText>
          </FormControl>

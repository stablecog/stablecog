...
import type { ApiPublishResponse } from '$routes/api/publish';
import { ApplicationBar } from '$routes/chatgpt/components/ApplicationBar';
import { ChatMessageList } from '$routes/chatgpt/components/ChatMessageList';
import { type ChatModelId, type SystemPurposeId, SystemPurposes } from '$routes/chatgpt/lib/data';
import { Composer } from '$routes/chatgpt/components/Composer';
import { ConfirmationModal } from '$routes/chatgpt/components/dialogs/ConfirmationModal';
// import { Link } from '$routes/chatgpt/components/util/Link';
import { PublishedModal } from '$routes/chatgpt/components/dialogs/PublishedModal';
import { createDMessage, type DMessage, downloadConversationJson, useChatStore } from '$routes/chatgpt/lib/stores/store-chats';
import { publishConversation } from '$routes/chatgpt/lib/util/publish';
import { speakIfFirstLine } from '$routes/chatgpt/lib/util/text-to-speech';
import { streamAssistantMessage, updateAutoConversationTitle } from '$routes/chatgpt/lib/llm/ai';
    ...
    <Box
      ...
      <ApplicationBar
        ...
        sx={{
          ...
          // ...(env.NODE_ENV === 'development' ? { background: theme.vars.palette.danger.solidBg } : {}),
        }} />
      ...
      <ConfirmationModal
        ...
        confirmationText={<>
          Share your conversation anonymously on <a href='https://paste.gg' target='_blank'>paste.gg</a>?

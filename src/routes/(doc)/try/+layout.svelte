...
<div style="min-height: 100vh; min-height: 100svh" class="relative flex w-full items-stretch">
	<Sidebar class="hidden w-64 md:flex lg:w-72" sidebar={trySidebar} />
...
<Drawer hasCustomContent>
	<div
		class="sticky top-0 z-10 flex w-full -translate-y-2px
		transform items-stretch justify-between gap-2 border-b-2 border-c-bg-secondary bg-c-bg"
	>
		<h3
